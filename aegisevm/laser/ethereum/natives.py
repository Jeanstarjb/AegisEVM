...
from aegisevm.laser.ethereum.state.calldata import BaseCalldata, ConcreteCalldata
from aegisevm.laser.ethereum.util import extract32, extract_copy
from aegisevm.support.support_utils import sha3, zpad
